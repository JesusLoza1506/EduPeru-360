...
@section('content')
<div class="container-fluid p-0 d-flex justify-content-center align-items-center" style="min-height: 100vh; background-color: var(--light-green);">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="text-center mb-4">
                    <h2 class="fw-bold text-success animate__animated animate__fadeIn">¡HOLA ESTUDIANTE!</h2>
                    <p class="lead text-secondary mb-4">Consulta tus notas, tareas, horario y certificados</p>
                    <img src="{{ asset('imagenes/estudiantes.jpg') }}" alt="Grupo de alumnos felices" class="img-fluid rounded-4 shadow-lg animate__animated animate__zoomIn" style="max-height:220px; object-fit:cover; border: 4px solid #fff;">
                </div>

                <div class="card shadow-lg border-0 animate__animated animate__fadeInUp" style="border-radius: 1.5rem;">

                    <div class="card-header text-white text-center p-3" style="background-color: var(--success); border-radius: 1.5rem 1.5rem 0 0;">
                        <h4 class="mb-0 fw-bold">ACCESO AL AULA VIRTUAL</h4>
                    </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="/login/estudiantes">
                            @csrf
                            <div class="mb-4">
                                <label for="codigo" class="form-label fw-semibold">Código de alumno o DNI</label>
                                <div class="input-group input-group-lg">
                                    <span class="input-group-text"><i class="bi bi-person-badge"></i></span>
                                    <input type="text" class="form-control" id="codigo" name="codigo" placeholder="202300123" required>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 mb-3 mt-4">
                                <button type="submit" class="btn btn-success btn-lg shadow-sm fw-bold">
                                    <i class="bi bi-box-arrow-in-right me-2"></i> INGRESAR COMO ESTUDIANTE
                                </button>
                            </div>
                    ...
                    <div class="card-footer bg-light text-center p-3" style="border-radius: 0 0 1.5rem 1.5rem;">
                        <span class="small text-muted">¿Problemas para acceder? Contacta a tu tutor.</span>
                    </div>
                </div>
